...
string resturant,food,room,specialfood,		//THIS IS GLOBAL DECLARATION OF STRING
	foodname1,foodname2,foodname3,foodname4,foodname5,foodname6,foodname7,foodname8,foodname9,foodname10,foodname11,foodname12,foodname13,
...
void printbill()
{
	...
	cout<<"*******************************************************************************************************************\n";
	cout<<endl;
	cout<<setw(20)<<"NAME"<<setw(20)<<"QUANTITY"<<setw(20)<<"DAYS"<<setw(20)<<"PRICE"<<setw(20)<<"TOTAL"<<endl;
	cout<<endl;
	cout<<"*******************************************************************************************************************\n";
	cout<<endl;
	cout<<setw(20)<<foodname1<<setw(20)<<quantity1<<setw(40)<<price1<<setw(20)<<"$"<<bill1<<endl;
	cout<<setw(20)<<foodname2<<setw(20)<<quantity2<<setw(40)<<price2<<setw(20)<<"$"<<bill2<<endl;
	cout<<setw(20)<<foodname3<<setw(20)<<quantity3<<setw(40)<<price3<<setw(20)<<"$"<<bill3<<endl;
	cout<<setw(20)<<foodname4<<setw(20)<<quantity4<<setw(40)<<price4<<setw(20)<<"$"<<bill4<<endl;
	cout<<setw(20)<<foodname5<<setw(20)<<quantity5<<setw(40)<<price5<<setw(20)<<"$"<<bill5<<endl;
	cout<<setw(20)<<foodname6<<setw(20)<<quantity6<<setw(40)<<price6<<setw(20)<<"$"<<bill6<<endl;
	cout<<setw(20)<<foodname7<<setw(20)<<quantity7<<setw(40)<<price7<<setw(20)<<"$"<<bill7<<endl;
	cout<<setw(20)<<foodname8<<setw(20)<<quantity8<<setw(40)<<price8<<setw(20)<<"$"<<bill8<<endl;
	cout<<setw(20)<<foodname9<<setw(20)<<quantity9<<setw(40)<<price9<<setw(20)<<"$"<<bill9<<endl;
	cout<<setw(20)<<foodname10<<setw(20)<<quantity10<<setw(40)<<price10<<setw(20)<<"$"<<bill10<<endl;
	cout<<endl;
	cout<<"*******************************************************************************************************************\n";
}
...
void roombill()
{
	...
	cout<<"*******************************************************************************************************************\n";
	cout<<endl;
	cout<<setw(20)<<foodname11<<setw(20)<<days1<<setw(20)<<price11<<setw(20)<<"$"<<bill11<<endl;
	cout<<setw(20)<<foodname12<<setw(20)<<days2<<setw(20)<<price12<<setw(20)<<"$"<<bill12<<endl;
	cout<<setw(20)<<foodname13<<setw(20)<<days3<<setw(20)<<price13<<setw(20)<<"$"<<bill13<<endl;
	cout<<"*******************************************************************************************************************\n";
}
